...
trait CalendarDateDataTrait {
    ...
    private int $nepaliMonth = 9;
    private int $nepaliDay = 16;     // 17 - 1
    private int $dayOfWeek = 6;      // 7 - 1, 0 for sunday, 6 for saturday

    private int $englishYear = 1943;
    private int $englishMonth = 4;
    private int $englishDay = 13;    // 14 - 1
